...
c  A0 Y_{,2}
c
        A0gyi( :,7) = A0(:,1,1)*g2yi(:,1)
c    &              + A0(:,1,2)*g2yi(:,2)
c    &              + A0(:,1,3)*g2yi(:,3)
c    &              + A0(:,1,4)*g2yi(:,4)
     &              + A0(:,1,5)*g2yi(:,5)
c    &              + A0(:,1,6)*g2yi(:,6)
        A0gyi( :,8) = A0(:,2,1)*g2yi(:,1)
     &              + A0(:,2,2)*g2yi(:,2)
c    &              + A0(:,2,3)*g2yi(:,3)
c    &              + A0(:,2,4)*g2yi(:,4)
     &              + A0(:,2,5)*g2yi(:,5)
c    &              + A0(:,2,6)*g2yi(:,6)
        A0gyi( :,9) = A0(:,3,1)*g2yi(:,1)
c    &              + A0(:,3,2)*g2yi(:,2)
     &              + A0(:,3,3)*g2yi(:,3)
c    &              + A0(:,3,4)*g2yi(:,4)
     &              + A0(:,3,5)*g2yi(:,5)
c    &              + A0(:,3,6)*g2yi(:,6)
        A0gyi(:,10) = A0(:,4,1)*g2yi(:,1)
c    &              + A0(:,4,2)*g2yi(:,2)
c    &              + A0(:,4,3)*g2yi(:,3)
     &              + A0(:,4,4)*g2yi(:,4)
     &              + A0(:,4,5)*g2yi(:,5)
c    &              + A0(:,4,6)*g2yi(:,6)
        A0gyi(:,11) = A0(:,5,1)*g2yi(:,1)
     &              + A0(:,5,2)*g2yi(:,2)
     &              + A0(:,5,3)*g2yi(:,3)
     &              + A0(:,5,4)*g2yi(:,4)
     &              + A0(:,5,5)*g2yi(:,5)
     &              + A0(:,5,6)*g2yi(:,6)
        A0gyi(:,12) = A0(:,6,1)*g2yi(:,1)
c    &              + A0(:,6,2)*g2yi(:,2)
c    &              + A0(:,6,3)*g2yi(:,3)
c    &              + A0(:,6,4)*g2yi(:,4)
     &              + A0(:,6,5)*g2yi(:,5)
...
c  A0 Y_{,3}
c
        A0gyi(:,13) = A0(:,1,1)*g3yi(:,1)
c    &              + A0(:,1,2)*g3yi(:,2)
c    &              + A0(:,1,3)*g3yi(:,3)
c    &              + A0(:,1,4)*g3yi(:,4)
     &              + A0(:,1,5)*g3yi(:,5)
c    &              + A0(:,1,6)*g3yi(:,6)
        A0gyi(:,14) = A0(:,2,1)*g3yi(:,1)
     &              + A0(:,2,2)*g3yi(:,2)
c    &              + A0(:,2,3)*g3yi(:,3)
c    &              + A0(:,2,4)*g3yi(:,4)
     &              + A0(:,2,5)*g3yi(:,5)
c    &              + A0(:,2,6)*g3yi(:,6)
        A0gyi(:,15) = A0(:,3,1)*g3yi(:,1)
c    &              + A0(:,3,2)*g3yi(:,2)
     &              + A0(:,3,3)*g3yi(:,3)
c    &              + A0(:,3,4)*g3yi(:,4)
     &              + A0(:,3,5)*g3yi(:,5)
c    &              + A0(:,3,6)*g3yi(:,6)
        A0gyi(:,16) = A0(:,4,1)*g3yi(:,1)
c    &              + A0(:,4,2)*g3yi(:,2)
c    &              + A0(:,4,3)*g3yi(:,3)
     &              + A0(:,4,4)*g3yi(:,4)
     &              + A0(:,4,5)*g3yi(:,5)
c    &              + A0(:,4,6)*g3yi(:,6)
        A0gyi(:,17) = A0(:,5,1)*g3yi(:,1)
     &              + A0(:,5,2)*g3yi(:,2)
     &              + A0(:,5,3)*g3yi(:,3)
     &              + A0(:,5,4)*g3yi(:,4)
     &              + A0(:,5,5)*g3yi(:,5)
     &              + A0(:,5,6)*g3yi(:,6)
        A0gyi(:,18) = A0(:,6,1)*g3yi(:,1)
c    &              + A0(:,6,2)*g3yi(:,2)
c    &              + A0(:,6,3)*g3yi(:,3)
c    &              + A0(:,6,4)*g3yi(:,4)
     &              + A0(:,6,5)*g3yi(:,5)
