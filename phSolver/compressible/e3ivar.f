...
c Joe Pointer, Fall 2017, Mixture of thermally perfect gases in thermal non-equilibrium
c----------------------------------------------------------------------
c
        include "common.h"
c
